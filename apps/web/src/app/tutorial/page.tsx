...
const STEPS: Step[] = [
  ...
  /* ── 알아두면 좋은 것 ────────────────────────────────────────────── */
  {
    ...
    title: "분대장과 구제권",
    body: [
      "런이 시작되면 넷 중 한 명이 분대장이 됩니다. 무작위가 아니라 소총수 → 통신병 → 의무병 → 행정병 순서에서 실제 사람이 맡은 첫 자리가 분대장이 돼요. 머리 위 이름표 옆 다이아몬드 표시가 분대장입니다.",
      "마음에 안 들면 바꿀 수 있습니다. 접속 중인 인원의 과반이 한 사람에게 표를 주면 그 즉시 교체돼요(2:2 동수면 현직 그대로).",
